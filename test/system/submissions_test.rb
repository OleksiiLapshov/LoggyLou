...
class SubmissionsTest < ApplicationSystemTestCase
  ...
  test "should create submission" do
    ...
    fill_in "Note", with: @submission.note
    fill_in "Period end", with: @submission.period_end
    fill_in "Period start", with: @submission.period_start
    fill_in "Status", with: @submission.status
  ...
  test "should destroy Submission" do
    visit submission_url(@submission)
    accept_confirm { click_on "Destroy this submission", match: :first }
